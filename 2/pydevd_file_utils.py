...
GENYMOTION_SD_FOLDER   = '/storage/emulated/0/'
MOBILE_SD_FOLDER       = '/storage/sdcard0/'

SD_FOLDER = GENYMOTION_SD_FOLDER

PATHS_FROM_ECLIPSE_TO_PYTHON = [
    (r'C:\Users\Vlood\AppData\Roaming\Kodi\addons\plugin.video.collections',        SD_FOLDER + r'Android/data/org.xbmc.kodi/files/.kodi/addons/plugin.video.collections')
    #(r'C:\Users\Vlood\AppData\Roaming\Kodi\addons\script.module.oauth2client',      SD_FOLDER + r'Android/data/org.xbmc.kodi/files/.kodi/addons/script.module.oauth2client')
    #(r'C:\Python27\Lib', r'/home/jenkins/workspace/Android-ARM/tools/depends/xbmc-depends/arm-linux-androideabi-android-17/lib/python2.6')    
]   
